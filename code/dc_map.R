...
#
# Notes:
# A) 08/12/2019: Example code for the Cancer Preventorium
# ------------------------------------------------------- #
...
dc_ward <- rgdal::readOGR(dsn = "./data/dc_ward", layer = "Ward_from_2012")
dc_zip <- rgdal::readOGR(dsn = "./data/dc_zip", layer = "Zip_Codes")
dc_block <- rgdal::readOGR(dsn = "./data/dc_blocks", layer = "Census_Blocks__2010")
