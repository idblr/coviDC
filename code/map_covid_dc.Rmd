...
author: ~
date: '2020-05-16'
slug: cumulative-covid-dc-05142020
categories: ["R"]
tags: ["R Markdown", "leaflet", "R", "open data"]
subtitle: ''
summary: ''
authors: []
lastmod: '2020-05-17T8:47:18-04:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
ggplot2::ggplot() +                                      # initialize ggplot object
  ...
  ggplot2::ggtitle("Cumulative SARS-CoV-2 cases per 1,000 (March 7, 2020 - May 14, 2020)") + # add title
...
### Create leaflet plot
dc_m1 <- leaflet::leaflet(CoV_DC_WGS84) %>% # initial data = DC health planning neighborhood-level COVID-19 data
  leaflet::setView(lng = -38.9, lat = 77.0, zoom = 7) %>% # starting location (DC, USA)
